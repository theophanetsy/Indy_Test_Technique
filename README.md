...
*   **Evaluation des restrictions** : Pour l'évaluation des restrictions d'age, de date ou de météo sont plutôt straightforward. Pour l'évaluation des restrictions 'or' et 'and' on peut avoir plusieurs niveaux de restrictions imbriqués. Donc on utilise un algorithme récursif pour évaluer les restrictions complexes 'or' et 'and' et parcourir tout les niveaux de toutes les branches.
